		...
		<div class="row">
			<div class="col-12">
				...
				<div class="card-header" style="margin-top: 5px;">
					<h3 class="card-title">Franchisee wise Order</h3>
				</div>
					<div class="card-body">
						<form method="post" name="" action="<?php echo base_url();?>admin/Order/frnchiseewisesearch">
							<div class="row col-12">
								...
								<div class="col-3">
									...
									<select name="userid" class="form-control" required>
										...
										<?php 
										$ures = $this->db->query("select * from user where usertype='Franchise' ")->result_array();
										foreach($ures as $urows) {
										?>
										<option value="<?=$urows['id']?>"><?=$urows['fullname'];?></option>
									<?php } ?>
									</select>
								</div>
