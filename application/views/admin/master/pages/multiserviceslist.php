				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="text-right mb-3">
							...
							<a href="<?=base_url()?>admin/multiserviceadd">
								...
								foreach($res as $row) { $i++; ?>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url();?>admin/Managepage/multiservicesave/<?=$row['id']?>">
										...
										<td>
											...
											<a href="<?php echo base_url();?>admin/Managepage/multiservicedelete/<?=$row['id']?>"
